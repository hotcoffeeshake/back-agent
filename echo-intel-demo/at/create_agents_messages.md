...
tool contracts:
- catalog.list_devices: POST <MOCK_TOOL_BASE_URL>/tools/{scenario_id}/catalog.list_devices body {}
- catalog.list_professionals: POST <MOCK_TOOL_BASE_URL>/tools/{scenario_id}/catalog.list_professionals body {}
output contract:
{
  "scenario_id": "req_xx",
  "requirement_profile": {
...
- catalog.list_devices: POST <MOCK_TOOL_BASE_URL>/tools/{scenario_id}/catalog.list_devices body {}
- catalog.list_professionals: POST <MOCK_TOOL_BASE_URL>/tools/{scenario_id}/catalog.list_professionals body {}
- catalog.check_credentials: POST <MOCK_TOOL_BASE_URL>/tools/{scenario_id}/catalog.check_credentials body {"professional_id":null}
- inventory_schedule.check_stock: POST <MOCK_TOOL_BASE_URL>/tools/{scenario_id}/inventory_schedule.check_stock body {"device_id":null}
- inventory_schedule.check_availability: POST <MOCK_TOOL_BASE_URL>/tools/{scenario_id}/inventory_schedule.check_availability body {"time_window":{}}
- quote.get_price: POST <MOCK_TOOL_BASE_URL>/tools/{scenario_id}/quote.get_price body {"device_id":"","professional_id":""}
output contract:
{
  "offers": [
    {
